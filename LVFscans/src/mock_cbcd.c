    ...
    /******************************************************/
{
    ...
    char filename[] = "A.fits";             /* name for new FITS file */
...
void copyhdu( void)
{
    ...
    char infilename[]  = "A.fits";  /* name for existing FITS file   */
    char outfilename[] = "B.fits";  /* name for new FITS file        */
    ...
    /**********************************************************************/
{
    ...
    char filename[]  = "A.fits";     /* name of existing FITS file   */
